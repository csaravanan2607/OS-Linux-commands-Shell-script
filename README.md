...
cat > file1 chanchal singhvi c.k. shukla s.n. dasgupta sumit chakrobarty ^d chanchal singhvi c.k. shukla s.n. dasgupta sumit chakrobarty ^d
...
sed -n '2,4{s/$//;p}' file23 1001 | Ram | 10000 | HR 1002 | tom | 5000 | Admin* 1003 | Joe | 7000 | Developer*
...
OUTPUT
gzip backup.tar x file1.txt x directory1/ x directory1/file2.txt x directory1/file3.txt gzip backup.tar ls .gz
...
OUTPUT
./one bash: ./one: Permission denied 0 echo $?
...
OUTPUT
Welcome Ram/Rahim Please enjoy your visit Special testing account gganesh, Do not forget to logout when you're done Sorry, you are not allowed here cat > whiletest cat > whiletest
...
OUTPUT
word:I word:dont know if thisll word:work cat forin3.sh cat forin2.sh
...
OUTPUT
word:I word:don't word:know word:if word:this'll word:work cat forin3.sh
...
OUTPUT
The value of i is 1 The value of i is 2 The value of i is 3 The value of i is 4 The value of i is 5 cat forctype1.sh
...
OUTPUT
Iteration number: 1 Iteration number: 2 The for loop is completed $ chmod 755 forbreak.sh
...
./funcex.sh 1 2 1 2 The result is 2
